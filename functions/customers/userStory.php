...
if ($id_cliente <= 0) {
    echo "<p>ID cliente non valido.</p>";
    exit;
}

// Recupera il nome del cliente
$sqlCliente = "SELECT nome_cliente FROM clienti WHERE id_cliente = ?";
...
$sqlAppuntamenti = "
    ...
    WHERE a.id_cliente = ? AND a.completato = 1
    GROUP BY a.data_appuntamento, s.nome_servizio
    ORDER BY a.data_appuntamento ASC
";
$stmtAppuntamenti = $pdo->prepare($sqlAppuntamenti);
$stmtAppuntamenti->execute([$id_cliente]);
                ...
                <ol class="breadcrumb mb-4">
                    ...
                    <h1 class="h3 mb-4 text-gray-800 d-flex justify-content-between align-items-center">
                        <div class="d-flex align-items-center">
                            <i class="fas text-indigo fa-user-circle fa-2xl mr-2"></i>
                        ...
                        <?php else: ?>
                            ...
                            <?php foreach ($appuntamentiCompletati as $appuntamento): ?>
                                <li class="list-group-item m-1 border-0" style="border-bottom: solid 1px #ededed !important;">
                                    ...
                                    <?php echo htmlspecialchars($appuntamento['nome_servizio']); ?>
                                </li>
                            <?php endforeach; ?>
