...
$stmt = $pdo->prepare("SELECT a.id_appuntamento, a.badge_color, a.badge_text, a.id_cliente, c.nome_cliente, s.nome_servizio, a.data_appuntamento, a.tempo_servizio, c.numero_telefono as telefono_cliente , a.completato
                       FROM appuntamenti a
